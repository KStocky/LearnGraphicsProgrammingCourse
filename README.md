...
Published learner version: `course-v2026.08.23.4`
...
chapter available in `course-v2026.08.23.4`. It does not require a checkout of the private
...
The matching course site and tagged source archive use the same `course-v2026.08.23.4`
