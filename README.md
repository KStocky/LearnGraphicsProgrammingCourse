...
Published learner version: `course-v2026.08.23.3`
...
chapter available in `course-v2026.08.23.3`. It does not require a checkout of the private
...
The matching course site and tagged source archive use the same `course-v2026.08.23.3`
